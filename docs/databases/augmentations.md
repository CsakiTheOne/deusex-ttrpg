...
| Name                    | Cost | Activation | Power usage | Required augs        | Notes                                                                          |
| ----------------------- | ---- | ---------- | ----------- | -------------------- | ------------------------------------------------------------------------------ |
| Dialect Enhancer        | 1    | Contextual | -           | Social Enhancer      | Dominate conversation through chemical manipulation and strategic speechcraft. |
...
| Typhoon Explosive System   | 2    | Manual     | 5           | Cybernetic Arm                 | Kill everything around you.              |
